...
module.exports = () => {
    ...
    api.delete('/todo', async (req, res) => {
        try {
            ...
            res.status(200).json({ status: 'success', payload:  deleteTodos, message: 'All todos fetched successfully' });

        } catch (err) {
            res.status(200).json({ status: 'success', payload: deleteTodos, message: 'All courses fetched successfully' });
        }
    });
